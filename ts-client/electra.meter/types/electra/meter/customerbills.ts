...
function createBaseCustomerbills(): Customerbills {
  return {
    billCycleID: 0,
    customerDeviceID: "",
    billDate: 0,
...
export const Customerbills = {
  encode(message: Customerbills, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): Customerbills {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCustomerbills();
  ...
  fromJSON(object: any): Customerbills {
    return {
  ...
  toJSON(message: Customerbills): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<Customerbills>, I>>(object: I): Customerbills {
    const message = createBaseCustomerbills();
