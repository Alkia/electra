...
const baseCustomerbillingline: object = {
  customerdeviceID: "",
  cycleID: 0,
  lineid: 0,
  producerDeviceID: "",
...
export const Customerbillingline = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Customerbillingline {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseCustomerbillingline } as Customerbillingline;
  ...
  fromPartial(object: DeepPartial<Customerbillingline>): Customerbillingline {
    const message = { ...baseCustomerbillingline } as Customerbillingline;
    if (
      object.customerdeviceID !== undefined &&
      object.customerdeviceID !== null
