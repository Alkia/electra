 ...
 */
export type VoterParams = object;
...
/**
 * @title electra/voter/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/electra/voter/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<VoterQueryParamsResponse, RpcStatus>({
      path: `/electra/voter/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/electra/voter/poll
   */
  queryPollAll = (
    query?: {
   ...
   * @request GET:/electra/voter/poll/{id}
   */
