...
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        message.acknowledgements = ((_b = object.acknowledgements) !== null && _b !== void 0 ? _b : []).map((e) => channel_1.PacketState.fromJSON(e));
        message.commitments = ((_c = object.commitments) !== null && _c !== void 0 ? _c : []).map((e) => channel_1.PacketState.fromJSON(e));
        message.receipts = ((_d = object.receipts) !== null && _d !== void 0 ? _d : []).map((e) => channel_1.PacketState.fromJSON(e));
        message.sendSequences = ((_e = object.sendSequences) !== null && _e !== void 0 ? _e : []).map((e) => exports.PacketSequence.fromJSON(e));
        message.recvSequences = ((_f = object.recvSequences) !== null && _f !== void 0 ? _f : []).map((e) => exports.PacketSequence.fromJSON(e));
        message.ackSequences = ((_g = object.ackSequences) !== null && _g !== void 0 ? _g : []).map((e) => exports.PacketSequence.fromJSON(e));
        message.nextChannelSequence =
            object.nextChannelSequence !== undefined && object.nextChannelSequence !== null
                ? long_1.default.fromString(object.nextChannelSequence)
...
const basePacketSequence = { portId: "", channelId: "", sequence: long_1.default.UZERO };
