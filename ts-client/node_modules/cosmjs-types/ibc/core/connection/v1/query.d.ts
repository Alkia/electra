    ...
    fromPartial<I extends {
        ...
        connection?: ({
            ...
            versions?: ({
                ...
                identifier?: string | undefined;
                features?: (string[] & string[] & Record<Exclude<keyof I["connection"]["versions"][number]["features"], number | keyof string[]>, never>) | undefined;
            } & Record<Exclude<keyof I["connection"]["versions"][number], keyof import("../../../../ibc/core/connection/v1/connection").Version>, never>)[] & Record<Exclude<keyof I["connection"]["versions"], number | keyof {
                identifier?: string | undefined;
                features?: string[] | undefined;
            }[]>, never>) | undefined;
            state?: import("../../../../ibc/core/connection/v1/connection").State | undefined;
    ...
    fromPartial<I extends {
        ...
        connections?: ({
            ...
            versions?: ({
                ...
                identifier?: string | undefined;
                features?: (string[] & string[] & Record<Exclude<keyof I["connections"][number]["versions"][number]["features"], number | keyof string[]>, never>) | undefined;
            } & Record<Exclude<keyof I["connections"][number]["versions"][number], keyof import("../../../../ibc/core/connection/v1/connection").Version>, never>)[] & Record<Exclude<keyof I["connections"][number]["versions"], number | keyof {
                identifier?: string | undefined;
                features?: string[] | undefined;
            }[]>, never>) | undefined;
            state?: import("../../../../ibc/core/connection/v1/connection").State | undefined;
            ...
            } & Record<Exclude<keyof I["connections"][number]["counterparty"], keyof import("../../../../ibc/core/connection/v1/connection").Counterparty>, never>) | undefined;
            delayPeriod?: string | number | (Long.Long & {
                high: number;
                low: number;
                unsigned: boolean;
        ...
        } & Record<Exclude<keyof I["connections"][number], keyof IdentifiedConnection>, never>)[] & Record<Exclude<keyof I["connections"], number | keyof {
            id?: string | undefined;
            clientId?: string | undefined;
            versions?: {
                identifier?: string | undefined;
...
export declare const QueryClientConnectionsResponse: {
    ...
    fromPartial<I extends {
        ...
        connectionPaths?: (string[] & string[] & Record<Exclude<keyof I["connectionPaths"], number | keyof string[]>, never>) | undefined;
        proof?: Uint8Array | undefined;
        proofHeight?: ({
            revisionNumber?: string | number | Long.Long | undefined;
            revisionHeight?: string | number | Long.Long | undefined;
