...
exports.QueryEvidenceResponse = {
    ...
    fromJSON(object) {
        const message = Object.assign({}, baseQueryEvidenceResponse);
        message.evidence =
            object.evidence !== undefined && object.evidence !== null ? any_1.Any.fromJSON(object.evidence) : undefined;
        return message;
    },
    toJSON(message) {
        const obj = {};
...
exports.QueryAllEvidenceResponse = {
    ...
    fromJSON(object) {
        var _a;
        const message = Object.assign({}, baseQueryAllEvidenceResponse);
        message.evidence = ((_a = object.evidence) !== null && _a !== void 0 ? _a : []).map((e) => any_1.Any.fromJSON(e));
        message.pagination =
            object.pagination !== undefined && object.pagination !== null
