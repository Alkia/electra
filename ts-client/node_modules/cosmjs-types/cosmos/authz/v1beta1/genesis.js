...
exports.GenesisState = {
    ...
    fromJSON(object) {
        var _a;
        const message = Object.assign({}, baseGenesisState);
        message.authorization = ((_a = object.authorization) !== null && _a !== void 0 ? _a : []).map((e) => exports.GrantAuthorization.fromJSON(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        var _a;
        const message = Object.assign({}, baseGenesisState);
        message.authorization = ((_a = object.authorization) === null || _a === void 0 ? void 0 : _a.map((e) => exports.GrantAuthorization.fromPartial(e))) || [];
        return message;
    },
};
