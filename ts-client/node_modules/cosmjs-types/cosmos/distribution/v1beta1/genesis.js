    ...
    fromJSON(object) {
        ...
        message.validatorAddress =
            object.validatorAddress !== undefined && object.validatorAddress !== null
                ...
                : "";
        message.outstandingRewards = ((_a = object.outstandingRewards) !== null && _a !== void 0 ? _a : []).map((e) => coin_1.DecCoin.fromJSON(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
...
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        message.feePool =
            object.feePool !== undefined && object.feePool !== null ? distribution_1.FeePool.fromJSON(object.feePool) : undefined;
        message.delegatorWithdrawInfos = ((_a = object.delegatorWithdrawInfos) !== null && _a !== void 0 ? _a : []).map((e) => exports.DelegatorWithdrawInfo.fromJSON(e));
        message.previousProposer =
            object.previousProposer !== undefined && object.previousProposer !== null
                ? String(object.previousProposer)
                : "";
        message.outstandingRewards = ((_b = object.outstandingRewards) !== null && _b !== void 0 ? _b : []).map((e) => exports.ValidatorOutstandingRewardsRecord.fromJSON(e));
        message.validatorAccumulatedCommissions = ((_c = object.validatorAccumulatedCommissions) !== null && _c !== void 0 ? _c : []).map((e) => exports.ValidatorAccumulatedCommissionRecord.fromJSON(e));
        message.validatorHistoricalRewards = ((_d = object.validatorHistoricalRewards) !== null && _d !== void 0 ? _d : []).map((e) => exports.ValidatorHistoricalRewardsRecord.fromJSON(e));
        message.validatorCurrentRewards = ((_e = object.validatorCurrentRewards) !== null && _e !== void 0 ? _e : []).map((e) => exports.ValidatorCurrentRewardsRecord.fromJSON(e));
        message.delegatorStartingInfos = ((_f = object.delegatorStartingInfos) !== null && _f !== void 0 ? _f : []).map((e) => exports.DelegatorStartingInfoRecord.fromJSON(e));
        message.validatorSlashEvents = ((_g = object.validatorSlashEvents) !== null && _g !== void 0 ? _g : []).map((e) => exports.ValidatorSlashEventRecord.fromJSON(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
