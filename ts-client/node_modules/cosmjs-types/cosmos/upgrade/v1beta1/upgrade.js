...
exports.SoftwareUpgradeProposal = {
    ...
    fromJSON(object) {
        ...
        message.plan = object.plan !== undefined && object.plan !== null ? exports.Plan.fromJSON(object.plan) : undefined;
        return message;
    },
    toJSON(message) {
        const obj = {};
...
exports.ModuleVersion = {
    ...
    fromJSON(object) {
        ...
        message.name = object.name !== undefined && object.name !== null ? String(object.name) : "";
        message.version =
            object.version !== undefined && object.version !== null ? long_1.default.fromString(object.version) : long_1.default.UZERO;
        return message;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromPartial(object) {
        ...
        message.name = (_a = object.name) !== null && _a !== void 0 ? _a : "";
        message.version =
            object.version !== undefined && object.version !== null ? long_1.default.fromValue(object.version) : long_1.default.UZERO;
        return message;
    },
};
