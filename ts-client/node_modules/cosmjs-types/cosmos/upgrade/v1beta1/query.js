...
exports.QueryCurrentPlanResponse = {
    ...
    fromJSON(object) {
        const message = Object.assign({}, baseQueryCurrentPlanResponse);
        message.plan = object.plan !== undefined && object.plan !== null ? upgrade_1.Plan.fromJSON(object.plan) : undefined;
        return message;
    },
    toJSON(message) {
        const obj = {};
    ...
    fromJSON(object) {
        ...
        message.lastHeight =
            object.lastHeight !== undefined && object.lastHeight !== null
                ? long_1.default.fromString(object.lastHeight)
                : long_1.default.ZERO;
        return message;
    },
    toJSON(message) {
...
exports.QueryModuleVersionsResponse = {
    ...
    fromJSON(object) {
        var _a;
        const message = Object.assign({}, baseQueryModuleVersionsResponse);
        message.moduleVersions = ((_a = object.moduleVersions) !== null && _a !== void 0 ? _a : []).map((e) => upgrade_1.ModuleVersion.fromJSON(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
