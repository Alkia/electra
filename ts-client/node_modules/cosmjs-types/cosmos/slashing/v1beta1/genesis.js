...
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        message.signingInfos = ((_a = object.signingInfos) !== null && _a !== void 0 ? _a : []).map((e) => exports.SigningInfo.fromJSON(e));
        message.missedBlocks = ((_b = object.missedBlocks) !== null && _b !== void 0 ? _b : []).map((e) => exports.ValidatorMissedBlocks.fromJSON(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
...
exports.ValidatorMissedBlocks = {
    ...
    fromJSON(object) {
        ...
        const message = Object.assign({}, baseValidatorMissedBlocks);
        message.address = object.address !== undefined && object.address !== null ? String(object.address) : "";
        message.missedBlocks = ((_a = object.missedBlocks) !== null && _a !== void 0 ? _a : []).map((e) => exports.MissedBlock.fromJSON(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
...
const baseMissedBlock = { index: long_1.default.ZERO, missed: false };
exports.MissedBlock = {
    encode(message, writer = minimal_1.default.Writer.create()) {
