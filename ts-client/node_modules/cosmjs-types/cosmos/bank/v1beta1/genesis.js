...
exports.GenesisState = {
    ...
    fromJSON(object) {
        ...
        message.balances = ((_a = object.balances) !== null && _a !== void 0 ? _a : []).map((e) => exports.Balance.fromJSON(e));
        message.supply = ((_b = object.supply) !== null && _b !== void 0 ? _b : []).map((e) => coin_1.Coin.fromJSON(e));
        message.denomMetadata = ((_c = object.denomMetadata) !== null && _c !== void 0 ? _c : []).map((e) => bank_1.Metadata.fromJSON(e));
        return message;
    },
    toJSON(message) {
        const obj = {};
