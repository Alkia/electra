    ...
    describe("signAndBroadcast", () => {
        describe("direct mode", () => {
            ...
            it("works with auto gas", async () => {
                (0, testutils_spec_1.pendingWithoutSimapp)();
                const wallet = await proto_signing_1.DirectSecp256k1HdWallet.fromMnemonic(testutils_spec_1.faucet.mnemonic);
                const client = await signingstargateclient_1.SigningStargateClient.connectWithSigner(testutils_spec_1.simapp.tendermintUrl, wallet, Object.assign(Object.assign({}, testutils_spec_1.defaultSigningClientOptions), { gasPrice: testutils_spec_1.defaultGasPrice }));
                const msg = tx_2.MsgDelegate.fromPartial({
                    delegatorAddress: testutils_spec_1.faucet.address0,
                    validatorAddress: testutils_spec_1.validator.validatorAddress,
                    amount: (0, proto_signing_1.coin)(1234, "ustake"),
            ...
            it("works with a modifying signer", async () => {
                ...
                expect(Object.assign({}, tx.authInfo.fee.amount[0])).toEqual((0, proto_signing_1.coin)(3000, "ucosm"));
    ...
    describe("sign", () => {
        describe("direct mode", () => {
            ...
            it("works with a modifying signer", async () => {
                ...
                expect(Object.assign({}, authInfo.fee.amount[0])).toEqual((0, proto_signing_1.coin)(3000, "ucosm"));
