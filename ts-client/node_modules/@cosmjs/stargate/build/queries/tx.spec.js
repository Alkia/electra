...
async function makeClientWithTx(rpcUrl) {
    ...
    return [queryclient_1.QueryClient.withExtensions(tmClient, tx_1.setupTxExtension), tmClient];
}
describe("TxExtension", () => {
    ...
    describe("simulate", () => {
        it("works", async () => {
            ...
            expect((_c = response.gasInfo) === null || _c === void 0 ? void 0 : _c.gasWanted).toEqual((0, utils_2.longify)(long_1.default.UZERO));
            tmClient.disconnect();
        });
    });
});
