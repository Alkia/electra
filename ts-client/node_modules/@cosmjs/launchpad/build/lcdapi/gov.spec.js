        ...
        if ((0, testutils_spec_1.launchpadEnabled)()) {
            ...
            const proposalMsg = {
                ...
                value: {
                    ...
                    initial_deposit: (0, amino_1.coins)(25000000, "ustake"),
                },
            };
            ...
            const proposalSignDoc = (0, amino_1.makeSignDoc)([proposalMsg], defaultFee, chainId, proposalMemo, proposalAccountNumber, proposalSequence);
            ...
            (0, cosmosclient_1.assertIsBroadcastTxSuccess)(proposalResult);
            ...
            const voteSignDoc = (0, amino_1.makeSignDoc)([voteMsg], defaultFee, chainId, voteMemo, voteAccountNumber, voteSequence);
