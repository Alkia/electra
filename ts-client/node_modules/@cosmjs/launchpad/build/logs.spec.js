...
describe("logs", () => {
    describe("parseAttribute", () => {
        it("works", () => {
            const attr = (0, logs_1.parseAttribute)({ key: "a", value: "b" });
            expect(attr).toEqual({ key: "a", value: "b" });
        });
        it("works for empty value", () => {
            const attr = (0, logs_1.parseAttribute)({ key: "foobar", value: "" });
            expect(attr).toEqual({ key: "foobar", value: "" });
        });
        it("normalized unset value to empty string", () => {
            const attr = (0, logs_1.parseAttribute)({ key: "amount" });
    ...
    describe("parseEvent", () => {
        it("works", () => {
            ...
            const event = (0, logs_1.parseEvent)(original);
    ...
    describe("parseLog", () => {
        it("works", () => {
            ...
            const log = (0, logs_1.parseLog)(original);
    ...
    describe("parseLogs", () => {
        it("works", () => {
            ...
            const logs = (0, logs_1.parseLogs)(original);
