...
describe("HMAC", () => {
    it("can perform HMAC(SHA1) according to Botan test vectors", () => {
        ...
        {
            const hmac = new hmac_1.Hmac(sha_1.Sha1, (0, encoding_1.fromHex)("0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B0B"));
            hmac.update((0, encoding_1.fromHex)("4869205468657265"));
            expect(hmac.digest()).toEqual((0, encoding_1.fromHex)("B617318655057264E28BC0B6FB378C8EF146BE00"));
        }
        {
            const hmac = new hmac_1.Hmac(sha_1.Sha1, (0, encoding_1.fromHex)("0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C"));
            hmac.update((0, encoding_1.fromHex)("546573742057697468205472756E636174696F6E"));
            expect(hmac.digest()).toEqual((0, encoding_1.fromHex)("4C1A03424B55E07FE7F27BE1D58BB9324A9A5A04"));
        }
        {
            const hmac = new hmac_1.Hmac(sha_1.Sha1, (0, encoding_1.fromHex)("4CA0EF38F1794B28A8F8EE110EE79D48CE13BE25"));
            ...
            expect(hmac.digest()).toEqual((0, encoding_1.fromHex)("AA4AE5E15272D00E95705637CE8A3B55ED402112"));
        }
        {
            const hmac = new hmac_1.Hmac(sha_1.Sha1, (0, encoding_1.fromHex)("4CA0EF38F1794B28A8F8EE110EE79D48CE13BE25"));
            hmac.update((0, encoding_1.fromHex)("54657374205573696E67204C6172676572205468616E20426C6F636B2D53697A65204B657920616E64204C6172676572205468616E204F6E6520426C6F636B2D53697A652044617461"));
            expect(hmac.digest()).toEqual((0, encoding_1.fromHex)("E8E99D0F45237D786D6BBAA7965C7808BBFF1A91"));
        }
        {
            const hmac = new hmac_1.Hmac(sha_1.Sha1, (0, encoding_1.fromHex)("0102030405060708090A0B0C0D0E0F10111213141516171819"));
            ...
            expect(hmac.digest()).toEqual((0, encoding_1.fromHex)("4C9007F4026250C6BC8414F9BF50C86C2D7235DA"));
        }
        {
            const hmac = new hmac_1.Hmac(sha_1.Sha1, (0, encoding_1.fromHex)("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"));
            ...
            expect(hmac.digest()).toEqual((0, encoding_1.fromHex)("125D7342B9AC11CD91A39AF48AA17B4F63F175D3"));
        }
    });
