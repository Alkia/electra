...
SNAP_PATH="$HOME/snapshots/electra"
LOG_PATH="$HOME/snapshots/electra/electra_log.txt"
DATA_PATH="$HOME/.electra/data/"
SERVICE_NAME="electra.service"
...
now_date() {
    echo -n $(TZ=":Asia/Bangkok" date '+%Y-%m-%d_%H:%M:%S')
}
