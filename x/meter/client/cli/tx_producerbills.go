...
func CmdCreateProducerbills() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "create-producerbills [bill-cycle-id] [producerdevice-id] [bill-date] [bill-total-wh] [bill-total-price] [bill-currency] [bill-valid] [paid]",
...
func CmdUpdateProducerbills() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "update-producerbills [bill-cycle-id] [producerdevice-id] [bill-date] [bill-total-wh] [bill-total-price] [bill-currency] [bill-valid] [paid]",
...
func CmdDeleteProducerbills() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "delete-producerbills [bill-cycle-id] [producerdevice-id]",
