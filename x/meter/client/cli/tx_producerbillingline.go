...
func CmdCreateProducerbillingline() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "create-producerbillingline [producer-device-id] [cycle-id] [lineid] [customerdevice-id] [bill-contract-id] [line-wh] [line-wh-price] [curency] [decremented] [phase]",
...
func CmdUpdateProducerbillingline() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "update-producerbillingline [producer-device-id] [cycle-id] [lineid] [customerdevice-id] [bill-contract-id] [line-wh] [line-wh-price] [curency] [decremented] [phase]",
