...
func CmdCreateCustomerbills() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "create-customerbills [bill-cycle-id] [customerdevice-id] [bill-date] [bill-total-wh] [bill-total-price] [bill-currency] [bill-valid] [paid]",
...
func CmdUpdateCustomerbills() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "update-customerbills [bill-cycle-id] [customerdevice-id] [bill-date] [bill-total-wh] [bill-total-price] [bill-currency] [bill-valid] [paid]",
...
func CmdDeleteCustomerbills() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "delete-customerbills [bill-cycle-id] [customerdevice-id]",
